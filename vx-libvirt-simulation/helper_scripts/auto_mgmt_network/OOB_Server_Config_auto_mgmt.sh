...
#    using topology data from: cumulus-ansible-intermediate-mlag-nclu.dot
...
REPOSITORY="https://github.com/CumulusNetworks/cumulus-ansible-intermediate-mlag-nclu"
REPONAME="cumulus-ansible-intermediate-mlag-nclu"
